...
public class GeneralNumberTest extends BasicTestCase {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(GeneralNumberTest.class);
	int d1 = 1;
	int d2 = 2;
	...
	public void testAdd() throws Exception {
		...
		AssertJUnit.assertEquals(
				this.getFileContent("/exp/general_add_expected.html"), str);
	...
	public void testMinus() throws Exception {
		...
		LOG.debug(str);
		AssertJUnit.assertEquals(
				this.getFileContent("/exp/general_minus_expected.html"), str);
	...
	public void testCompare() throws Exception {
		...
		LOG.debug(str);
		AssertJUnit.assertEquals(
				this.getFileContent("/exp/general_compare_expected.html"), str);
	...
	public void testDiv() throws Exception {
		...
		LOG.debug(str);
		AssertJUnit.assertEquals(
				this.getFileContent("/exp/general_div_expected.html"), str);
